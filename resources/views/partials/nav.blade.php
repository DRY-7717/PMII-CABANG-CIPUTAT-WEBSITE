                ...
                <nav class="hidden z-50 py-5 lg:py-2 lg:block lg:static  bg-white absolute w-full max-w-[250px] lg:max-w-full top-full right-4 rounded-lg shadow-md shadow-slate-500 lg:shadow-none lg:bg-transparent lg:rounded-none"
                    ...
                    <ul class="block lg:flex">
                        <li class="group links lg:hover:bg-primary transition duration-200 lg:rounded-full ">
                            <a href="#home"
                                class="text-base lg:text-[15px]  text-slate-800 hover:text-primary lg:text-white lg:group-hover:text-white py-1  mx-5 flex">Home</a>
                        </li>
                        <li class="group links relative lg:hover:bg-primary transition duration-200 lg:rounded-full "><a
                                href="#about"
                                class="text-base lg:text-[15px] text-slate-800 hover:text-primary lg:text-white lg:group-hover:text-white py-1  mx-5 flex">About</a>
                            {{-- <ul
                                ...
                                <li class=" hover:bg-slate-100  transition duration-500"><a href="#gallery"
                                        class="text-base lg:text-base text-slate-800 hover:text-first  py-1  mx-5 flex">Gallery</a>
                                </li>
                        ...
                        <li class="group lg:hover:bg-primary transition duration-200 lg:rounded-full"><a href="/team"
