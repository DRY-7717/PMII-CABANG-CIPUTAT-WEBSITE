<header class=" header flex  items-center w-full   absolute top-0 left-0 ">
    <div class="container px-4 lg:px-16 lg:max-w-full  md:max-w-full sm:max-w-full">
        <div class="flex justify-between  items-center relative ">
            <div class="px-4 logom flex z-50">
            ...
            <div class="flex px-4 items-center ">
                <div class="lg:hidden z-50" id="hamburger">
                ...
                <nav class="hidden z-[9999] py-5 lg:py-2 lg:block lg:static  bg-white absolute w-full max-w-[300px] lg:max-w-full top-full right-4 rounded-lg shadow-md shadow-slate-500 lg:shadow-none lg:bg-transparent lg:rounded-none"
                    id="nav-menu">
                    <ul class="block lg:flex">
                        <li class="group links lg:hover:bg-primary transition duration-200 lg:rounded-full ">
                            <a href="#home"
                        ...
                        <li class="group links relative lg:hover:bg-primary transition duration-200 lg:rounded-full "><a
                                href="#about"
                            ...
                            {{-- <ul
                                ...
                                <li class=" hover:bg-slate-100  transition duration-500"><a href="#gallery"
                                        class="text-base lg:text-base text-slate-800 hover:text-first  py-1  mx-3 flex">Gallery</a>
                                </li>
                        ...
                        <li class="links group lg:hover:bg-primary transition duration-200 lg:rounded-full"><a
                                href="#gallery"
                        ...
                        <li
                            ...
                            <ul
                                ...
                                <li class=" hover:bg-slate-100  transition duration-500" {{ Request::is('team')
                                    ? 'active' : '' }}><a href="/team"
                        ...
                        {{-- end team md sm --}}
                        <li
                            class="hidden lg:block group lg:hover:bg-primary transition duration-200 lg:rounded-full relative">
                            <a href="#"
                            ...
                            <ul
                                ...
                                <li class=" hover:bg-slate-100  transition duration-500"><a href="/programs"
                                        class="text-base lg:text-base text-slate-800 hover:text-first  py-1  mx-3 flex items-center mb-2"><i
                                            class="fas fa-clipboard-list mr-2"></i>Program</a>
                                </li>
                                <li class=" hover:bg-slate-100  transition duration-500"><a href="/news"
                                        class="text-base lg:text-base text-slate-800 hover:text-first  py-1  mx-3 flex items-center mb-2"><i
                                ...
                                <li class=" hover:bg-slate-100  transition duration-500"><a href="/mails"
                                        class="text-base lg:text-base text-slate-800 hover:text-first  py-1  mx-3 flex items-center mb-2"><i
                        ...
                        @auth
                        <li
                            class="group lg:hover:bg-primary border-t lg:border-none transition duration-200 lg:rounded-full  flex items-center text-white relative {{ Request::is('login') ? 'active' : '' }}">
                            <a href="/login"
