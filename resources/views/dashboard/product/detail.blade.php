            ...
            <div class="row justify-content-center my-1">
                <div class="col-lg-10">
                    ...
                    <div class="group-button mt-5 mb-5 d-inline">
                        <a href="/dashboard/product" class="btn btn-success px-3"><i
                                class="fas fa-long-arrow-alt-left"></i> Back to All product</a>

                        <a href="/dashboard/product/{{ $product->slug }}/edit" class="btn btn-primary"><i
                                class="fas fa-edit"></i>
                            Edit</a>
