            ...
            <div class="row">
                <div class="col-12">
                    <div class="card  shadow" style="border-radius: 15px; background-color:rgb(230, 232, 255);">
                        ...
                        <div class="card-body">
                            <form action="/dashboard/award/{{ $award->slug }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror "
                                            name="slug" id="slug" value="{{ old('slug',$award->slug) }}">
                                        @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="categoryprogram_id" id="category">
                                            ...
                                            @if (old('categoryprogram_id',$award->categoryprogram_id) == $category->id)
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <textarea class="summernote"
                                            name="body">{{ old('body',$award->body) }}</textarea>
...
<script>
    ...
    title.addEventListener('change',function () {  
        fetch('/dashboard/award/checkslug?title=' + title.value)
