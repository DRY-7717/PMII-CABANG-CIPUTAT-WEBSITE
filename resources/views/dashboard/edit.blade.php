            ...
            <div class="row">
                <div class="col-12">
                    <div class="card  shadow" style="border-radius: 15px; background-color:rgb(230, 232, 255);">
                        ...
                        <div class="card-body">
                            <form action="/dashboard/program/{{ $program->slug }}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            name="title" id="title" value="{{ old('title',$program->title) }}">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror "
                                            name="slug" id="slug" value="{{ old('slug',$program->slug) }}">
                                        @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        @if ($program->image)
                                        <img src="{{ asset('storage/'.$program->image) }}" class="img-preview  img-fluid mb-2">
                                        @else
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        @enderror
                                        <textarea class="summernote" name="body">{{ old('body',$program->body) }}</textarea>
